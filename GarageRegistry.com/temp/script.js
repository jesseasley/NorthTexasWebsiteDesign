    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data == "") {
                ...
                if ("user" in user) {
                    $("#liRegister").html("<a href=\"#MyGarage\" class=\"blackmenu\" onclick='showPage(\"myGaragePage.php\", \"myGarageMenu\");'>My Garage</a>");
                    $("#liLogin").html("<a href=\"#Home\" class=\"blackmenu\" onclick='logOut();'>Sign Out</a>");
                    $("#liRegister2").html("<a href=\"#MyGarage\" class=\"redlogin\" onclick='showPage(\"myGaragePage.php\", \"myGarageMenu\");'>My Garage</a>");
                    $("#liLogin2").html("<a href=\"#Home\" class=\"redlogin\" onclick='logOut();'>SIGN OUT</a>");
                }
            }
            //msg("get cookie: " + data);
        }
...
function showPartLinkModal(path) {
    ...
    path = window.location.host + "/" + window.location.pathname + path;
    path = window.location.protocol + "//" + path.replace("//", "/");
    $("#divPartImagePath").html(path);
}
function showPictureLinkModal(path) {
    $("#imagePicturePathDialog").modal("show");
    path = window.location.host + "/" + window.location.pathname + path;
    path = window.location.protocol + "//" + path.replace("//", "/");
    $("#divPictureImagePath").html(path);
}
...
function logOut() {
    PartHolding = "";
    PhotoHolding = "";
    $("#liRegister").html("<a href=\"#\" class=\"blackmenu\" data-toggle=\"modal\" data-target=\"#registerModal\">Register</a>");
    $("#liLogin").html("<a href=\"#\" class=\"blackmenu\" data-toggle=\"modal\" data-target=\"#loginModal\">SIGN IN</a>");
    $("#liRegister2").html("<a href=\"#\" class=\"redlogin\" data-toggle=\"modal\" data-target=\"#registerModal\">Register</a>");
    $("#liLogin2").html("<a href=\"#\" class=\"redlogin\" data-toggle=\"modal\" data-target=\"#loginModal\">SIGN IN</a>");
    $.ajax({
        type: "POST",
        url: "setCookie.php",
